...
//            "hdfs://input////"
        ...
        public void cleanup(Context context) throws IOException,
            ...
            String str = "";
            str += all;
            context.write(new Text(File_name + " " + "!"), new Text(str)); // es: filename ! 200
    ...
    public static class Combiner_Part1 extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            // 将key中单词和文件名进行互换。es: test1.txt hello -> hello test1.txt
            String p[] = key.toString().split(" ");
            String key_to = "";
            key_to += p[1];
            key_to += " ";
            key_to += p[0];
            context.write(new Text(key_to), new Text(value)); //es: key:hello test1.txt value:0.0012
        }
    }
...
//    }
    ...
    public static class Mapper_Part2 extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            context.write(new Text(s1), new Text(s2)); //es: key:hello  value: test1.txt 0.0012 1
        }
    }
